...
const Orders = () => {
  const { products, backendUrl, token, currency, currencyCode } = useContext(ShopContext);
          ...
          return (
            <div key={index} className="py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-6 text-sm">
                {/* ---  Images  --- */}
                {/* <img className="w-16 sm:w-20" src={Array.isArray(item.image) ? item.image[0] : item.image || "/placeholder.png"} alt="" /> */}
